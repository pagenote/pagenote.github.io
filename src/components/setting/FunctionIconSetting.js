...
const defaultFuns = {
  ...
  fanyi: {
    ...
    record: {
        ...
        name:'创建一个标记',
        shortcut:'',
        clickScript: `(function(){API.methods.record({bg:"#e2e202"});})();`
    },
    mailto:{
    ...
    <div className='function-setting-form'>
...

      {
        ...
        <div>
          ...
          <div>
            <div className="label">S按钮图标 <a target='_blank' href="https://www.iconfont.cn/">找图</a></div><input placeholder='svg图片或者网络https链接图片' ref={iconInput} type="text" defaultValue={funItem.icon}/>
          </div>
          <div>
