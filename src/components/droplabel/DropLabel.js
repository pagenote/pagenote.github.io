...
import './droplabel.scss';

export default function DropLabels({categories=[{label:'default'}],currentCategories,onSet}) {
    ...
    return(
        <div className='category-label'>
            ...
            <div className={`droplabel ${show?'show':'hide'}`} onBlur={()=>{setTimeout(()=>{onSet()},400)}}>
